...
public class LinhaObstaculoBuilder {
    ...
    public LinhaObstaculoBuilder definirX(int x) {
        this.linhaObstaculo.setX(x);
        return this;
    }
    ...
    public LinhaObstaculoBuilder definirVelX(int velX) {
        this.linhaObstaculo.setVelX(velX);
        return this;
    }
